...
int SCREEN_WIDTH = 0;//1280;
int SCREEN_HEIGHT = 0;//720;
...
void handleMouse()
{
  if(usingKinect)
  {
    ...
    if(!kinectReset)
    {
        ...
        else if(kinectSwipe != SWIPE_NONE)
        {
            ...
            /*if(inAnycast)
            {
              ...
              if (nearest!=null) 
              {
                ...
                nearest.AddInCountry(qCountry);
                 println("nearest = " + nearest.name + " for " + q.pos); 
              }
            }
            */
